...
title RESTORE Realme C53 (RMX3760) - Original VBMeta Only
...
echo.
echo   %Y%boot_a TIDAK diubah oleh script ini.%Z%
echo.
...
echo   %C%%B%  ORIGINAL VBMETA ONLY - VIA BROM%Z%
echo   %C%%B%====================================================%Z%
echo.
echo   Tujuan : kembalikan vbmeta_a ke original (boot_a tidak disentuh)
echo   Slot   : A
echo.
exit /b 0
