...
title RESTORE BOOT ONLY - Realme C53 (RMX3760) - Stock boot
...
echo.
echo   %Y%vbmeta_a dan init_boot_a TIDAK diubah oleh script ini.%Z%
echo.
choice /C YN /N /M "   Lanjutkan restore boot (Y/N)"
...
echo.
echo   %C%%B%====================================================%Z%
echo   %C%%B%  RESTORE BOOT ONLY - REALME C53 (RMX3760)%Z%
echo   %C%%B%  Kembalikan boot_a ke stock (vbmeta/init_boot utuh)%Z%
echo   %C%%B%====================================================%Z%
echo.
exit /b 0
