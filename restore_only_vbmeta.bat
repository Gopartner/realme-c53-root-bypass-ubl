...
title RESTORE VBMETA ONLY - Realme C53 (RMX3760) - Original vbmeta
...
echo.
echo   %Y%boot_a dan init_boot_a TIDAK diubah oleh script ini.%Z%
echo.
choice /C YN /N /M "   Lanjutkan restore vbmeta (Y/N)"
...
echo.
echo   %G%%B%  RESTORE VBMETA BERHASIL%Z%
echo.
...
echo.
echo   %C%%B%====================================================%Z%
echo   %C%%B%  RESTORE VBMETA ONLY - REALME C53 (RMX3760)%Z%
echo   %C%%B%  Kembalikan vbmeta_a ke original (boot/init_boot utuh)%Z%
echo   %C%%B%====================================================%Z%
echo.
exit /b 0
